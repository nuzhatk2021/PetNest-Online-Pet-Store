...
=======
              ...
              disabled={inCart}
              onClick={() => addItem(pet)}
              className="text-sm px-4 py-2 rounded-full transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              style={
                inCart
                  ? { background: "rgba(255,255,255,0.08)", color: "var(--petnest-muted, rgb(163 163 163))" }
                  : { background: "var(--petnest-accent, #E8C547)", color: "var(--petnest-accent-text, #070707)" }
              }
            >
