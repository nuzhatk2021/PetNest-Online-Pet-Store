...
=======
                        <p className="text-sm text-neutral-500">{money(it.price)} · max 1 per pet</p>
>>>>>>> 3a88ab5 (update)
                      </div>
                      <button
...
=======
                      <p className="text-sm text-neutral-500">Quantity: 1</p>
                      <p className="font-semibold text-yellow-400">{money(Number(it.price) || 0)}</p>
>>>>>>> 3a88ab5 (update)
                    </div>
                  </div>
                </div>
